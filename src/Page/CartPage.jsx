      ...
      {cartItems.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-4 ">
            {cartItems.map((item) => (
              <div key={item.id} className="bg-white rounded-xl p-4 flex gap-4 items-center border-2  hover:shadow-md transition-shadow">
                <img 
                  src={item.img} 
                  alt={item.name} 
                ...
                <div className="flex justify-between  w-full">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-5">{item.name}</h3>
